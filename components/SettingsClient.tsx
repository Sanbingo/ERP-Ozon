...
export default function SettingsClient({ stores, groupedConfigs }: SettingsClientProps) {
          ...
          <section className="erp-card overflow-hidden">
            <div className="p-6 border-b flex justify-between items-center bg-white">
              ...
              <button 
                ...
                className="text-primary hover:bg-primary/5 px-3 py-1.5 rounded-lg text-sm font-bold flex items-center gap-2 transition-colors"
              >
